...
const PlumbingServiceComponent = () => {
  ...
  return (
    <div className="bg-[#EFEFEF] min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="lg:flex justify-between ">
            ...
            <div className="flex items-center w-[300px]  overflow-hidden">
              ...
              />
              <button className="bg-[#B6B6B6] px-4 py-2 my-4 flex items-center justify-center rounded-r-full">
          ...
          {/* Cities List */}
          <div className="text-gray-700 text-md font-semibold leading-relaxed">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            {/* Contact Section */}
            <div>
              <div className="text-orange-500 text-xl font-medium mb-4 border-b-2 border-orange-500 inline-block pb-1">
                Klempner in Neuss
              </div>
